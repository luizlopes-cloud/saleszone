-- Add rd_source column ([RD] Source from Pipedrive)
ALTER TABLE squad_deals ADD COLUMN IF NOT EXISTS rd_source TEXT;

-- Update RPC: filter by rd_source containing 'paga' instead of canal='12'
