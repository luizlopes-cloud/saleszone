...
-- RPC para registrar acesso com session_id
...
-- RPC para atualizar heartbeat de sessão ativa
...
-- Atualizar analytics para incluir tempo de sessão (DROP primeiro pois return type mudou)
